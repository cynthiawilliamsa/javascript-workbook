...
let nums = [];
const strAsNum = strNums.map(str => nums.push(str));
console.log(strAsNum);
// Find the sum of the even values
let sumEvens = [];
const evenSum = strNums.reduce((total, currentValue) => currentValue % 2 === 0 ? sumEvens.push(total + currentValue) : total, 0)  
console.log(evenSum);
// console.log(sumEvens);

// Find the index of the first "Austin" value (the value plus its index equals 512)  //missing an array for this?
// const atxIdx;
